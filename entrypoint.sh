...
if [ -n "$INPUT_WORKFLOW_THEME_ID" ]; then
  export SHOP_THEME_ID="$INPUT_WORKFLOW_THEME_ID"
elif [ -n "$INPUT_DEFAULT_THEME_ID" ]; then
  export SHOP_THEME_ID="$INPUT_DEFAULT_THEME_ID"
else
  export SHOP_THEME_ID="$INPUT_THEME_ID"
fi
